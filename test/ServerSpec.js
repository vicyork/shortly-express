...
// Invoke the callback in the beforeEach function on line 17.
/************************************************************/
...
describe('', function(){
  ...
  beforeEach(function(){
    ...
    // delete link for roflzoo from db so it can be created later for the
    // test
    db.knex('urls')
  ...
  describe('Link creation:', function(){
    ...
    it('Only shortens valid urls, returning a 404 - Not found for invalid urls', function(done){
      ...
      requestWithSession(options, function(error, res, body){
        // res comes from the request module, and may not follow express
        // conventions
